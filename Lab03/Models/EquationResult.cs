namespace Lab03.Models
{
    public class EquationResult
    {
        ...
        public EquationResult(double b0, double b1, double b2, double b3, double b4, double b12, double b13, double b14, double b23, double b24, double b34, double b123, double b124, double b134, double b234, double b1234)
        {
            B0 = b0;
            B1 = b1;
            B2 = b2;
